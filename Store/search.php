			...
			<div class="row">
				<div class="col-sm-3">
					...
					<div class="features_items"><!--features_items-->
						...
						<?php
						$Search = $_POST['search']; 
						$query = "SELECT products.prod_id, products.prod_photo, products.prod_price, products.prod_design, vendors.full_name, vendors.vendor_id FROM vendors , products where products.id_vendor=vendors.vendor_id and ( products.prod_design like '%$Search%') ";
						$result = mysqli_query($connect,$query);
						$i=0;
						while($prod=mysqli_fetch_row($result))
						{
						...
						if($i==0)
							echo "<center><h1>NO PRODUCT</h1></center>";
						?>
					</div><!--features_items-->
				</div>
			</div>
