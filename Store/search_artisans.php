				...
				<div class="row">
					...
					<div class="col-sm-3">
						<div class="search_box pull-right">
							<form action="search_artisans.php" method="post">
								<table>
       								<td>
										<input type="text" placeholder="Search Artisans" name="search"/>
		...
		<div class="container">
			<div class="row">
					<div class="features_items"><!--features_items-->
						<h2 class="title text-center">Artisans</h2>
						<?php
						$i=0;
						$Search = $_POST['search'];
						$query = "SELECT vendor_id, name_store, photo_store FROM vendors where name_store like '%$Search%'";
						$result = mysqli_query($connect,$query);
						while($prod=mysqli_fetch_row($result))
						{
							$i=1;
							...
							echo "<img src='../../marketplace/pages/vendor/uploads/$prod[2]' alt='' />";
							echo "<h2>$prod[1]</h2>";			
							echo "<a href='blog-single.php?num=$prod[0]' class='btn btn-default add-to-cart'>View Profile</a></div></div></div></div>";
						}
						if($i==0)
							echo "<center><h1>NO ARTISAN</h1></center>";
						?>
