			...
			<div class="row">
				<div class="col-sm-3">
						...
						<div class="brands_products"><!--brands_products-->
							...
							<div class="single-products">
								<div class="productinfo text-center">
									...
									$num=$_GET['num'];
									$num1=$_GET['num1'];
									$query = "SELECT full_name, photo_store from vendors where vendors.vendor_id=$num1"; 
									$result = mysqli_query($connect,$query);
									while($prod=mysqli_fetch_array($result))
									{
										echo "<img class='product-image-wrapper' src='../../marketplace/pages/vendor/uploads/$prod[1]' alt='' /><h2>$prod[0]</h2>";
									}
									echo "<a href='blog-single.php?num=$num1' class='btn btn-default add-to-cart'>Return to profile</a>";
								?>
					...
					<div class="features_items"><!--features_items-->
						...
						if($num=='all')
						{
							$query = "SELECT products.prod_id, products.prod_photo, products.prod_price, products.prod_design, vendors.full_name, vendors.vendor_id FROM vendors , products, categories where products.id_vendor=vendors.vendor_id and id_categ=categorie_id and vendors.vendor_id =$num1";
						}
						else
						{
							$query = "SELECT products.prod_id, products.prod_photo, products.prod_price, products.prod_design, vendors.full_name, vendors.vendor_id FROM vendors , products, categories where products.id_vendor=vendors.vendor_id and id_categ=categorie_id and categorie_id=$num and vendors.vendor_id =$num1";
						}
						$result = mysqli_query($connect,$query);
						while($prod=mysqli_fetch_row($result))
						{
